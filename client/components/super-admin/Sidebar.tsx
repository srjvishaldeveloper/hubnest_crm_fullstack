...
import {
  ...
  Sparkles, CreditCard, Tag, TrendingUp, LayoutGrid,
    ...
    <>
      ...
      >
        ...
        <div className={`flex items-center gap-3 px-5 h-[72px] border-b border-slate-100 dark:border-[#1f1f1f] shrink-0 ${collapsed ? 'md:justify-center md:px-0' : ''}`}>
          <Image src="/images/Logo Image.png" alt="HubNest CRM" width={100} height={36} className={`object-contain shrink-0 ${collapsed ? 'md:w-10 md:h-10' : ''}`} />
