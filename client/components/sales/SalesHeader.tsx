      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3.5 min-w-0">
          ...
          <div className="min-w-0">
            <h1 className="text-[20px] font-bold text-[#0F172A] leading-tight tracking-tight font-sans">{meta.title}</h1>
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="hidden md:flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 w-52 lg:w-64 focus-within:border-[#2563EB] focus-within:bg-white transition group">
          ...
          <button className="flex items-center gap-2 pl-2 sm:pl-3 border-l border-slate-200 ml-1">
            ...
            <div className="hidden lg:flex flex-col items-start leading-tight">
              <span className="text-xs font-semibold text-[#0F172A]">{user?.name || 'Sales Executive'}</span>
