...
export default function GlobalSettingsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-[#0F172A]">Global Settings</h1>
        <p className="text-xs text-[#64748B] mt-0.5">Manage platform branding, email gateways, and compliance</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-2xl border border-slate-200/60 p-5 space-y-4">
          <h3 className="text-sm font-bold flex items-center gap-2"><Globe className="w-4 h-4 text-blue-500" /> Platform Branding</h3>
          <div className="space-y-4">
            ...
            <button className="px-4 py-2 bg-blue-600 text-white text-xs font-bold rounded-lg hover:bg-blue-700">Save Branding</button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/60 p-5 space-y-4">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm bg-slate-50" defaultValue="smtp.gmail.com" disabled />
            </div>
            <div>
              <label className="text-xs font-semibold text-slate-700 block mb-1">SMTP Port</label>
              <input type="text" className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm bg-slate-50" defaultValue="587" disabled />
            </div>
