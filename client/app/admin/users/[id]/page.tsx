      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-2xl border border-slate-200/60 p-6">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="mt-4 text-lg font-bold text-[#0F172A] dark:text-[#F9FAFB]">{user.name}</h2>
          ...
          <div className="mt-6 grid grid-cols-2 gap-2">
            <button className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 text-xs font-semibold text-slate-600 hover:bg-slate-50 dark:bg-[#161616] transition"><Pencil className="w-3.5 h-3.5"/> Edit</button>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="bg-white rounded-2xl border border-slate-200/60 p-6">
            <h3 className="text-sm font-bold text-[#0F172A] dark:text-[#F9FAFB] mb-4 flex items-center gap-2"><Shield className="w-4 h-4 text-[#2563EB]"/>Permissions</h3>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white rounded-2xl border border-slate-200/60 p-6">
            <h3 className="text-sm font-bold text-[#0F172A] dark:text-[#F9FAFB] mb-4 flex items-center gap-2"><Activity className="w-4 h-4 text-[#2563EB]"/>Activity Summary</h3>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="p-4 bg-blue-50 rounded-xl text-center"><p className="text-2xl font-bold text-[#0F172A] dark:text-[#F9FAFB]">{user.performance.loginDays}</p><p className="text-xs text-slate-500 mt-0.5">Login Days</p></div>
              <div className="p-4 bg-violet-50 rounded-xl text-center"><p className="text-2xl font-bold text-[#0F172A] dark:text-[#F9FAFB]">{user.performance.actions}</p><p className="text-xs text-slate-500 mt-0.5">Actions</p></div>
              <div className="p-4 bg-emerald-50 rounded-xl text-center"><p className="text-2xl font-bold text-[#0F172A] dark:text-[#F9FAFB]">{user.performance.leadsHandled}</p><p className="text-xs text-slate-500 mt-0.5">Leads Handled</p></div>
              <div className="p-4 bg-amber-50 rounded-xl text-center"><p className="text-2xl font-bold text-[#0F172A] dark:text-[#F9FAFB]">{user.performance.dealsClosed}</p><p className="text-xs text-slate-500 mt-0.5">Deals Closed</p></div>
            </div>
          </motion.div>
          {/* Performance */}
