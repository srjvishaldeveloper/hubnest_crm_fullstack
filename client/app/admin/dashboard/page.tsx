...
const quickActions = [
  { label: 'Add User', href: '/admin/users', icon: Users, color: 'bg-blue-50 text-blue-600 hover:bg-blue-100' },
  { label: 'Assign Role', href: '/admin/users', icon: Shield, color: 'bg-violet-50 text-violet-600 hover:bg-violet-100' },
  { label: 'View Reports', href: '/admin/reports', icon: BarChart3, color: 'bg-emerald-50 text-emerald-600 hover:bg-emerald-100' },
  { label: 'Launch Campaign', href: '/admin/crm-control', icon: Rocket, color: 'bg-amber-50 text-amber-600 hover:bg-amber-100' },
];
  ...
  return (
    <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay }}>
      <div className="flex items-end justify-between mb-4">
        <div><h2 className="text-[15px] font-bold text-[#0F172A]">{title}</h2>{sub && <p className="text-xs text-[#64748B] mt-0.5">{sub}</p>}</div>
      </div>
      {children}
    </motion.section>
  );
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <Sec title="Department Overview" sub="Sales, marketing, support & finance at a glance" delay={0.05}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-200/60 p-5">
            <div className="flex items-center justify-between mb-3"><h3 className="text-sm font-bold text-[#0F172A]">Sales Overview</h3><span className="text-xs text-emerald-600 font-semibold flex items-center gap-0.5"><ArrowUpRight className="w-3 h-3"/>+18%</span></div>
            <div className="grid grid-cols-3 gap-3 mb-3">
              <div className="p-3 bg-blue-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">{ls.total}</p><p className="text-[10px] text-slate-500">Leads</p></div>
              <div className="p-3 bg-emerald-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">{ls.converted}</p><p className="text-[10px] text-slate-500">Converted</p></div>
              <div className="p-3 bg-violet-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">42%</p><p className="text-[10px] text-slate-500">Conv. Rate</p></div>
            </div>
          ...
          {/* Marketing */}
          <div className="bg-white rounded-2xl border border-slate-200/60 p-5">
            <div className="flex items-center justify-between mb-3"><h3 className="text-sm font-bold text-[#0F172A]">Marketing Overview</h3><span className="text-xs text-emerald-600 font-semibold flex items-center gap-0.5"><ArrowUpRight className="w-3 h-3"/>+24%</span></div>
            <div className="grid grid-cols-3 gap-3 mb-3">
              <div className="p-3 bg-violet-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">24</p><p className="text-[10px] text-slate-500">Campaigns</p></div>
              <div className="p-3 bg-blue-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">3.2x</p><p className="text-[10px] text-slate-500">ROI</p></div>
              <div className="p-3 bg-emerald-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">₹2.1L</p><p className="text-[10px] text-slate-500">Spend</p></div>
            </div>
          ...
          {/* Support */}
          <div className="bg-white rounded-2xl border border-slate-200/60 p-5">
            <div className="flex items-center justify-between mb-3"><h3 className="text-sm font-bold text-[#0F172A]">Support Overview</h3><span className="text-xs text-amber-600 font-semibold">4 pending SLA</span></div>
            <div className="grid grid-cols-3 gap-3">
              <div className="p-3 bg-rose-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">42</p><p className="text-[10px] text-slate-500">Open</p></div>
              <div className="p-3 bg-emerald-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">128</p><p className="text-[10px] text-slate-500">Resolved</p></div>
              <div className="p-3 bg-amber-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">16</p><p className="text-[10px] text-slate-500">Pending</p></div>
            </div>
          ...
          {/* Finance */}
          <div className="bg-white rounded-2xl border border-slate-200/60 p-5">
            <div className="flex items-center justify-between mb-3"><h3 className="text-sm font-bold text-[#0F172A]">Finance Snapshot</h3><span className="text-xs text-emerald-600 font-semibold flex items-center gap-0.5"><ArrowUpRight className="w-3 h-3"/>+22%</span></div>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-emerald-50 rounded-xl"><p className="text-xs text-slate-500 mb-0.5">Revenue</p><p className="text-lg font-bold text-[#0F172A]">₹8.24L</p></div>
              <div className="p-3 bg-amber-50 rounded-xl"><p className="text-xs text-slate-500 mb-0.5">Pending</p><p className="text-lg font-bold text-[#0F172A]">₹1.86L</p></div>
              <div className="p-3 bg-blue-50 rounded-xl"><p className="text-xs text-slate-500 mb-0.5">Collected</p><p className="text-lg font-bold text-[#0F172A]">₹6.38L</p></div>
              <div className="p-3 bg-rose-50 rounded-xl"><p className="text-xs text-slate-500 mb-0.5">Overdue</p><p className="text-lg font-bold text-[#0F172A]">₹0.42L</p></div>
            </div>
          </div>
        </div>
      </Sec>
      ...
      <Sec title="User Analytics" sub="Activity patterns and role breakdown" delay={0.1}>
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          <div className="lg:col-span-3 bg-white rounded-2xl border border-slate-200/60 p-5">
            <h3 className="text-sm font-bold text-[#0F172A] mb-1">User Activity</h3>
            <div className="grid grid-cols-3 gap-3 mb-3">
              <div className="p-3 bg-blue-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">5</p><p className="text-[10px] text-slate-500">New Users</p></div>
              <div className="p-3 bg-emerald-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">{us.active}</p><p className="text-[10px] text-slate-500">Active Today</p></div>
              <div className="p-3 bg-violet-50 rounded-xl text-center"><p className="text-lg font-bold text-[#0F172A]">94%</p><p className="text-[10px] text-slate-500">Retention</p></div>
            </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200/60 p-5">
            <h3 className="text-sm font-bold text-[#0F172A] mb-3">Role Distribution</h3>
      ...
      <Sec title="Activity & Intelligence" sub="Timeline, alerts, and smart suggestions" delay={0.15}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          {/* Timeline */}
          <div className="bg-white rounded-2xl border border-slate-200/60 p-5">
            <h3 className="text-sm font-bold text-[#0F172A] mb-4 flex items-center gap-2"><Activity className="w-4 h-4 text-[#2563EB]"/>Recent Activities</h3>
            <div className="space-y-4">{recentActivities.map((a,i)=><div key={i} className="flex gap-3"><div className="flex flex-col items-center"><div className={`w-2.5 h-2.5 rounded-full ${a.color} mt-1 shrink-0`}/>{i<recentActivities.length-1&&<div className="w-px flex-1 bg-slate-200 my-1"/>}</div><div><p className="text-sm text-[#0F172A]">{a.action}</p><p className="text-[11px] text-slate-400 mt-0.5">{a.time}</p></div></div>)}</div>
          </div>
          {/* Alerts */}
          <div className="bg-white rounded-2xl border border-slate-200/60 p-5">
            <h3 className="text-sm font-bold text-[#0F172A] mb-4 flex items-center gap-2"><AlertTriangle className="w-4 h-4 text-amber-500"/>Alerts</h3>
            ...
            <div className="mt-5 pt-4 border-t border-slate-100">
              <h4 className="text-xs font-bold text-[#0F172A] mb-3">Security Status</h4>
              <div className="space-y-2">
                <div className="flex justify-between text-xs"><span className="text-slate-500">Login Attempts (24h)</span><span className="font-semibold text-[#0F172A]">142</span></div>
          ...
          {/* AI Insights */}
          <div className="bg-white rounded-2xl border border-slate-200/60 p-5">
            <h3 className="text-sm font-bold text-[#0F172A] mb-4 flex items-center gap-2"><Lightbulb className="w-4 h-4 text-amber-500"/>AI Insights</h3>
            <div className="space-y-3">{aiInsights.map((ins,i)=><div key={i} className={`p-3 rounded-xl border ${ins.color}`}><p className="text-xs font-bold text-[#0F172A]">{ins.title}</p><p className="text-[11px] text-slate-600 mt-1 leading-relaxed">{ins.desc}</p></div>)}</div>
          </div>
        </div>
      </Sec>
      ...
      <Sec title="Quick Actions & Integrations" sub="Shortcuts and service status" delay={0.2}>
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          <div className="lg:col-span-3 bg-white rounded-2xl border border-slate-200/60 p-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">{quickActions.map(q=><Link key={q.label} href={q.href} className={`flex flex-col items-center gap-2 p-4 rounded-xl border border-slate-100 transition ${q.color}`}><q.icon className="w-5 h-5"/><span className="text-xs font-semibold">{q.label}</span></Link>)}</div>
          </div>
          <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200/60 p-5">
            <h3 className="text-sm font-bold text-[#0F172A] mb-4">Integration Status</h3>
            <div className="space-y-3">{integrations.map(ig=><div key={ig.name} className="flex items-center justify-between p-3 rounded-xl border border-slate-100"><div className="flex items-center gap-3">{ig.status?<Wifi className="w-4 h-4 text-emerald-500"/>:<WifiOff className="w-4 h-4 text-red-500"/>}<span className="text-sm text-[#0F172A] font-medium">{ig.name}</span></div><span className={`px-2 py-0.5 rounded-full text-[11px] font-semibold ${ig.status?'bg-emerald-50 text-emerald-700':'bg-red-50 text-red-700'}`}>{ig.status?'Active':'Down'}</span></div>)}</div>
          </div>
        </div>
      </Sec>
      ...
      <Sec title="Recent Users" sub="Latest team members" delay={0.25}>
        <div className="bg-white rounded-2xl border border-slate-200/60 overflow-hidden">
          <div className="p-5 border-b border-slate-100 flex items-center justify-between">
            <h3 className="text-sm font-bold text-[#0F172A]">Users</h3>
            <Link href="/admin/users" className="text-xs text-[#2563EB] font-semibold hover:underline">View All →</Link>
          </div>
          <div className="overflow-x-auto"><table className="w-full text-left"><thead><tr className="border-b border-slate-100">{['Name','Role','Department','Status','Last Login'].map(h=><th key={h} className="px-5 py-3 text-[10px] font-semibold text-slate-500 uppercase tracking-wider">{h}</th>)}</tr></thead>
            <tbody>{MOCK_USERS.slice(0,5).map(u=><tr key={u.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
              <td className="px-5 py-3"><div className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-500 to-violet-400 flex items-center justify-center text-white text-xs font-bold">{u.avatar}</div><span className="text-sm font-medium text-[#0F172A]">{u.name}</span></div></td>
